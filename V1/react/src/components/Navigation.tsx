...
export const Navigation: React.FC<NavigationProps> = ({ onNavigateToDashboard }) => {
            ...
            {onNavigateToDashboard && (
              ...
              >
                <Button
                  ...
                  size="sm"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 py-2 rounded-xl shadow-lg"
                >
                  Try Demo
                </Button>
              </motion.div>
