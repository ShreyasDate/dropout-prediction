      ...
      >
        {[
          ...
          >
            ...
            >
              <Card className={`h-full bg-gradient-to-br ${feature.bgColor} backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-3xl overflow-hidden group`}>
              ...
              {/* 3D depth effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-gray-200/10 to-gray-300/10 dark:from-gray-700/10 dark:to-gray-800/10 rounded-3xl transform translate-x-1 translate-y-1 -z-10 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform duration-300" />
            </motion.div>
          </motion.div>
        ))}
      </motion.div>
