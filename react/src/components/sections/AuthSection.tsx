    ...
    >
      ...
      >
        <div className="text-center mb-12">
          <motion.h2 
            className="text-3xl font-bold mb-4 bg-gradient-to-r from-slate-800 to-slate-600 dark:from-white dark:to-slate-300 bg-clip-text text-transparent"
            variants={fadeInUpSpring}
          >
        ...
        <motion.div variants={scaleIn}>
          <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-0 shadow-2xl rounded-3xl overflow-hidden">
            <CardContent className="pt-8">
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <motion.div 
                    ...
                    className="group"
                  >
                    <div className={`relative bg-gradient-to-br ${role.bgColor} rounded-2xl p-6 border border-white/20 dark:border-slate-700/20 hover:shadow-xl transition-all duration-300`}>
                      <motion.div 
              ...
              <motion.div 
                className="flex items-center justify-center mt-8 text-sm text-slate-500 dark:text-slate-400"
                variants={fadeInUpSpring}
              >
                <motion.div
